...
public class Data {
	...
	public static Xlass[] getDefaultClasses() {
		...
		//**************************************************
		Xlass[] x = new Xlass[] {
				new Xlass("Emperor", new int[] { 20, 15, 6, 15, 10, 8, 7, 4 }, new int[] { Weapon.ANIMA, Weapon.ENERGY, Weapon.SWORD }, new double[] { .3, .7, .2, .5, .5, .3, .1, 0 }),
	...
	public static Weapon[] getDefaultWeapons() {
		...
		//******************************************************************************************
		return new Weapon[] {
				new Weapon("Falchion", Weapon.DIVINE, 1, 10, 0, .8, new int[] { Unit.DRAGON }, false, false),
				new Weapon("Killing Edge", Weapon.SWORD, 1, 6, 25, .85, new int[] { -1 }, false, false),
		};
	}
}
