...
public class Test {
	...
	public static void main(String[] args) {
		...
		Unit chrom = new Unit("Chrom", xlasses[1], weapons[1], true, new int[] { 1, 5, 4, 3, 10, 1, 4, 9, 4 });
		Unit alm = new Unit("Alm", xlasses[1], weapons[0], true, new int[] { 1, 5, 4, 3, 10, 1, 4, 9, 4 });

		Battle b = new Battle(new Unit[] { chrom }, new Unit[] { alm });
		b.doBattle(0, 0, false);
	}
